...
@if(auth()->user()->isAdmin())
    <div class="flex space-x-4 p-2">
        <a href="{{ $editRoute }}"
           class="p-6 px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg shadow hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition ease-in-out duration-150">
            {{ __('Edit') }}
        </a>
